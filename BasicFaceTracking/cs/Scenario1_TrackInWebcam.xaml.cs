    ...
    public sealed partial class Scenario1_TrackInWebcam : Page
    {
        ...
        private async Task<bool> StartWebcamStreamingAsync()
        {
            ...
            try
            {
                ...
                //client.BaseAddress = new Uri("http://10.7.0.2:8000/");
        ...
        private async Task ProcessCurrentVideoFrameAsync()
        {
            ...
            using (VideoFrame previewFrame = new VideoFrame(InputPixelFormat, (int)this.videoProperties.Width, (int)this.videoProperties.Height))
            {
                ...
                try
                {
                    ...
                    ///var image_bytes = await EncodedBytes(previewFrame.SoftwareBitmap, BitmapEncoder.JpegEncoderId);
                    ///string image = Convert.ToBase64String(image_bytes);
                    ///string request_json = "{'images': [\"" + image + "\"]}";
                    ///
                    ...
                    ///byte[] imageBytes = new byte[4 * previewFrame.SoftwareBitmap.PixelHeight * previewFrame.SoftwareBitmap.PixelWidth];
                    /// previewFrame.SoftwareBitmap.CopyToBuffer(imageBytes.AsBuffer());
                    /// 
                    ...
                    string request_json = JsonSerializer.Serialize(new { image=image_b64});
        ...
        private async Task<byte[]> EncodedBytes(SoftwareBitmap soft, Guid encoderId)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("Creating encoder");
                BitmapEncoder encoder = await BitmapEncoder.CreateAsync(encoderId, ms);
                System.Diagnostics.Debug.WriteLine("Setting bitmap");
                encoder.SetSoftwareBitmap(soft);
                System.Diagnostics.Debug.WriteLine("Set bitmap");
